...
// Deterministic heights for voice bars to prevent hydration mismatch
const VOICE_BAR_HEIGHTS = [
  9.4, 12.2, 7.3, 15.1, 17.4, 12.5, 9.0, 29.0, 16.1, 29.0,
  20.5, 19.9, 26.8, 12.3, 9.8, 12.6, 25.7, 20.5, 26.8, 21.7
];
          ...
          <div className={styles.voiceWaveform}>
            {VOICE_BAR_HEIGHTS.map((height, i) => (
              <div
                ...
                style={{ animationDelay: `${i * 0.05}s`, height: `${height}px` }}
              />
            ))}
          </div>
